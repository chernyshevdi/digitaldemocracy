...
export const SortBadge = ({ text, field }) => {
  ...
  const { setSortDirection, setSortField } = massmediaActionCreators();
  const sortDirection = useSelector((s: RootState) => s.massmedia.sort_direction);
  const sortField = useSelector((s: RootState) => s.massmedia.sort_field);
